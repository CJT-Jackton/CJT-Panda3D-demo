...
class AntiAliasing(ShowBase):
    def __init__(self):
        ...
        tmpnode.setShaderInput("fxaaQualitySubpix", float(0.75))
        tmpnode.setShaderInput("fxaaQualityEdgeThreshold", float(0.166))
        tmpnode.setShaderInput("fxaaQualityEdgeThresholdMin", float(0.0833))
